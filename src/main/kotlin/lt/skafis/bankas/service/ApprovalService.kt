...
interface ApprovalService {
    ...
    fun approve(sourceId: String, reviewMessage: String): Source
    fun reject(sourceId: String, reviewMessage: String): Source
    fun deleteSource(sourceId: String)
    fun deleteProblem(problemId: String)
    fun updateSource(sourceId: String, sourceData: SourceSubmitDto): Source
    fun updateProblem(
        problemId: String,
        problem: ProblemSubmitDto,
        problemImageFile: MultipartFile?,
