...
//    }
//
//    fun getProblemBySkfCode(skfCode: String): ProblemViewDto? {
//        val querySnapshot = firestore.collection(collectionPath)
//            .whereEqualTo("skfCode", skfCode)
//            .get()
//            .get()
//
//        return querySnapshot.documents.firstOrNull()?.toObject(ProblemViewDto::class.java)
//    }
//
...
//    }
//
//    fun getProblemsByAuthor(author: String): List<ProblemViewDto> {
//        val querySnapshot = firestore.collection(collectionPath)
