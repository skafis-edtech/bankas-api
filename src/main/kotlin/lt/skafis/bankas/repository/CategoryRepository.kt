...
@Repository
class CategoryRepository(private val firestore: Firestore) : FirestoreCrudRepository<Category>(firestore, Category::class.java) {
    override val collectionPath = "categories"

    fun getSearchPageableCategories(search: String, limit: Int, offset: Long): List<Category> {
        ...
        val filteredDocuments = if (!search.isEmpty()) {
